...
public struct Line: View {
    ...
    var gradient: GradientColor = GradientColor(start: Color.yellow, end: Color.white)
    var index:Int = 0
    ...
    public var body: some View {
        ZStack {
            if(self.showFull && self.showBackground){
                self.closedPath
                    .fill(LinearGradient(gradient: Gradient(colors: [Color.clear, .clear]), startPoint: .bottom, endPoint: .top))
